    ...
    <div class="row">
        <div class="col-md-8">
            <div class="jumbotron">
                ...
                <p>
                    Would you like to contribute? Make sure to register <a href="Here">Here</a> and contact us using the contact form <a href="">Here</a>. If you simply have suggestions for the site, do not hesitate to take contact either! This website is for the community, by the community, in the hopes that one day AoM will be as active and amazing as it once was.
                </p>
                @if(Auth::check())
                    @if(Auth::user()->admin)
