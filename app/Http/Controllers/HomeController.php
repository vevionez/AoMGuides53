...
/*	public function __construct()
	...
	public function streams()
	{
		...
		$aomeestreams = Cache::remember('aomeestreams', '2', function() {
			return getstreamsbygame("Age%20of%20Mythology%3A%20Extended%20Edition");
		});
		$aomttstreams = Cache::remember('aomttstreams', '2', function() {
			return getstreamsbygame("Age%20of%20Mythology%3A%20The%20Titans");
		});
		$aomstreams = Cache::remember('aomstreams', '2', function() {
